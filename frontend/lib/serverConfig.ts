...
export const serverConfig = {
  ...
  // Timeouts
  REQUEST_TIMEOUT_MS: parseIntOr(process.env.VITE_AI_REQUEST_TIMEOUT_MS, 60000),
  ...
  MAX_THINKING_BUDGET_CAP: parseIntOr(process.env.VITE_MAX_THINKING_BUDGET_CAP, 24000),
  DEFAULT_THINKING_BUDGET: parseIntOr(process.env.VITE_DEFAULT_THINKING_BUDGET, 16000),

  // Token / output limits
  DEFAULT_MAX_OUTPUT_TOKENS: parseIntOr(process.env.VITE_DEFAULT_MAX_OUTPUT_TOKENS, 16384),

  // Image handling
  IMAGE_SIZE_DIVISOR: parseIntOr(process.env.VITE_IMAGE_SIZE_DIVISOR, 2000),
  FILE_MAX_SIZE: parseIntOr(process.env.VITE_FILE_MAX_SIZE, 10 * 1024 * 1024),

  // Retry / backoff
  RATE_LIMIT_MAX_RETRIES: parseIntOr(process.env.VITE_RATE_LIMIT_MAX_RETRIES, 3),
  RATE_LIMIT_DELAY_MS: parseIntOr(process.env.VITE_RATE_LIMIT_DELAY_MS, 1000),
  ...
  // Thresholds
  HIGH_CONFIDENCE_THRESHOLD: parseFloatOr(process.env.VITE_HIGH_CONFIDENCE_THRESHOLD, 0.95),
